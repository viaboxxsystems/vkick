...
var Goals = React.createClass({
    ...
    render: function(){
        ...
        for (var i=0; i < 11; i++) {
            rows.push( <button key={i} className={'btn btn-default '+ this.props.teamclassName} onClick={this.handleClick.bind(this, i)}>{i}</button>);
        }
        return (
            <div>
          {rows}
...
var GamePlayer = React.createClass({
    render: function(){
        return (
            <li className={'label label-info playerName '+ this.props.team} onClick={this.handleClick}>{this.props.name}</li>
...
var Game = React.createClass({
    ...
    render: function(){
        return (
            <div className="row">
                <div className="col-md-3 players" >
                    <h4>Players</h4>
                    <div id="players">
